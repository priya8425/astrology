...
<body style="background-color:#eceff1 ">
    ...
    <div id="spinner"
        ...
        <!-- <img class="position-absolute top-50 start-50 translate-middle" src="img/icons/icon-6.png" alt="Icon"> -->
    </div>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn " data-wow-delay="0.1s" style="margin-top:-60px;">
        ...
        <div class="owl-carousel header-carousel position-relative ">
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            ...
                            <div class="col-md-7 col-lg-7 col-sm-3 stext">
                                 <img class="" src="img/om.png" alt="" style="height:250px;width:250px; margin-left:500px; margin-top:-170px;">
            ...
            <!-- <div class="owl-carousel-ite position-relative sliders" data-dot="<img src='img/astronomy.jpg'>">
                <img class="img-fluid bg" src="img/astronomy.jpg" alt="" style="height:100%; width:auto;">

                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-md-5 col-lg-5 col-sm-3">
                                <img class="img-fluid position-relative h-100 " src="img/om.png" alt="">
                            </div>
            ...
            <div class="owl-carousel-ite position-relative sliders" data-dot="<img src='img/banner1.jpg'>">
                ...
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-md-5 col-lg-5 col-sm-3">
                                <img class="img-fluid position-relative h-100 " src="img/ganesha.png" alt="">
                            </div>
                            <div class="col-md-1 col-lg-1"></div>
                            <div class="col-md-6 col-lg-6 col-sm-3 stext">
                                <h4 class="mob" style=" color:white;">Worried about your future?</h4>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="img/astro1.jpg" alt="">
                        <img class="img-fluid" src="img/astro1.jpg" alt="">
                    </div>
                </div>
    ...
    <div class="container-xlg py-5" style="background-color:#d96c06;">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h4 class=" mb-4">What do you get from ASTRO SIDDHIS</h4>
            </div>
            <div class="wrapper">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="card" style="border:none;">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a href="blog_details.php"
    ...
    <!-- Project Start -->
    <div class="container-xlg project py-5">
        <div class="container">
                ...
                <div class="col-lg-5">
                    <div class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4 active"
                            ...
                            <h5 class="m-0" style="color:black;">Astrology is one of the oldest science discovered by
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4"
                            ...
                            <h5 class="m-0" style="color:black;">Matchmaking is a unique method in Vedic astrology. It
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4"
                            ...
                            <h5 class="m-0" style="color:black;">Palmistry or Chiromancy is the science of
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-0"
                            ...
                            <h5 class="m-0" style="color:black;">Planets give both good and bad results. The results
                                ...
                                are Chart specific and problem specific. When remedies are done in a proper way it
                                reduces the problem to a great extent.</h5>
                        </button>
                    </div>
                </div>
                <div class="col-lg-7">
    ...
    <div class="container-xlg py-5"
        style="background-image:url('img/pexel6.jpg');background-color:#d96c06; height:560px; width: auto;opacity: 1.9;">
